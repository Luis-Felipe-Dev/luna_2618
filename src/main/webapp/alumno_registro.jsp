...
<!-- left column -->
          <div class="col-md-6 mt-2">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="registro" action="http://localhost:8080/luna_2618/alumno/registrar" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="carrera" name="carrera" placeholder="Enter carrera">
                  </div>
                 <div class="form-group">
                    <label for="exampleInputEmail1">PERIODO</label>
                    <input type="text" class="form-control" id="periodo" name="periodo" placeholder="Enter periodo">
                  </div>
                </div>
                <!-- /.card-body -->
